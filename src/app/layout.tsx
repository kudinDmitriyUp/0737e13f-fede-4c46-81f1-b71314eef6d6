...
export const metadata: Metadata = {
  title: "WaitlistApp - Join the Future of Mobile Productivity",
  description: "Get early access to the revolutionary mobile app that transforms productivity. Join 10K+ users on our exclusive waitlist and be first to launch.",
  keywords: "mobile app waitlist, productivity app, early access, beta testing, mobile productivity",
  metadataBase: new URL("https://waitlistapp.com"),
  alternates: {
    canonical: "https://waitlistapp.com"
  },
  openGraph: {
    title: "WaitlistApp - Join the Future of Mobile Productivity",
    description: "Get early access to the revolutionary mobile app that transforms productivity. Join 10K+ users on our exclusive waitlist.",
    siteName: "WaitlistApp",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763686527504-ym4p231i.jpg",
      alt: "WaitlistApp mobile interface preview"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "WaitlistApp - Join the Future of Mobile Productivity",
    description: "Get early access to the revolutionary mobile app that transforms productivity.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763686527504-ym4p231i.jpg"]
  },
  robots: {
    index: true,
    follow: true
